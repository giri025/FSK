...
```
# Output Waveform
![image](https://github.com/user-attachments/assets/58a38edc-ebe8-4d01-90f7-77ea728a8bd1)
# Results
Thus the FSK(Frequency shift keying) is performed using Python.
# Hardware experiment output waveform.
![WhatsApp Image 2025-04-23 at 14 11 32_af4a2d71](https://github.com/user-attachments/assets/5ef2d9b5-c8dd-4009-a226-ca499357486a)
